...
TreeMemSeries::TreeMemSeries(uint64_t sgid, uint16_t mid, uint32_t sid, uint64_t pos)
    : mutex_(),
      log_pos(pos),
      min_time_(std::numeric_limits<int64_t>::max()),
      max_time_(std::numeric_limits<int64_t>::min()),
...
TreeMemSeries::TreeMemSeries(uint64_t sgid, uint16_t mid, uint32_t sid, tsdb::head::MemSource *mem_source, uint64_t log_pos)
: mutex_(),
    log_pos(log_pos),
    min_time_(std::numeric_limits<int64_t>::max()),
    max_time_(std::numeric_limits<int64_t>::min()),
