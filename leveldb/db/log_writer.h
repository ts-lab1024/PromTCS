...
// Gorilla-compressed tree samples (bit-stream encoding)
std::string treeSamplesGorilla(tsdb::tsdbutil::TreeRefSample* samples, uint32_t item_num);
void treeSamplesGorilla(tsdb::tsdbutil::TreeRefSample* samples, uint32_t item_num, std::string* buf);
std::string treeSamplesGorilla(const std::vector<tsdb::tsdbutil::TreeRefSample*>& samples);
