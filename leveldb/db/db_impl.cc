...
void DBImpl::MaybeScheduleCompaction() {
  ...
  if (background_compaction_scheduled_) {
    ...
    // Compaction temporarily disabled (e.g., during query phases)
...
void DBImpl::SetDisableCompaction(bool disable) {
  MutexLock l(&mutex_);
  disable_compaction_ = disable;
  if (!disable) {
    // Re-enabling: schedule compaction if there's pending work
    MaybeScheduleCompaction();
  }
}
